<#
.SYNOPSIS
    Disables Game DVR to align with security policy.

.DESCRIPTION
    This script ensures the registry value 'AllowGameDVR' is set to 0
    under:
...
try {
    ...
    Write-Host "Successfully set AllowGameDVR to 0." -ForegroundColor Green

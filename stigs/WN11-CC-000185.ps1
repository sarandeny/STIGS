<#
.SYNOPSIS
    Disables Autorun functionality to enhance system security.

.DESCRIPTION
    This script ensures the registry value 'NoAutorun' is set to 1
    under:
...
try {
    ...
    Write-Host "Successfully set NoAutorun to 1." -ForegroundColor Green
